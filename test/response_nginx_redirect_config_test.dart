...
// tests for ResponseNginxRedirectConfig
void main() {
  final instance = ResponseNginxRedirectConfigBuilder();
  // TODO add properties to the builder and call build()

  group(ResponseNginxRedirectConfig, () {
    // String content
    ...
    // bool keepPath
    test('to test the property `keepPath`', () async {
      // TODO
    });
    ...
    // bool redirectRoot
    test('to test the property `redirectRoot`', () async {
      // TODO
    });
