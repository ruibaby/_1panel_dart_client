...
part 'response_website_dto.g.dart';
...
/// * [webSiteSSLId] 
@BuiltValue()
abstract class ResponseWebsiteDTO implements Built<ResponseWebsiteDTO, ResponseWebsiteDTOBuilder> {
  ...
  @BuiltValueField(wireName: r'accessLogPath')
  ...
  @BuiltValueField(wireName: r'errorLogPath')
  String? get errorLogPath;
  ...
  @BuiltValueField(wireName: r'sitePath')
  String? get sitePath;
  ...
  ResponseWebsiteDTO._();

  factory ResponseWebsiteDTO([void updates(ResponseWebsiteDTOBuilder b)]) = _$ResponseWebsiteDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ResponseWebsiteDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ResponseWebsiteDTO> get serializer => _$ResponseWebsiteDTOSerializer();
}

class _$ResponseWebsiteDTOSerializer implements PrimitiveSerializer<ResponseWebsiteDTO> {
  @override
  final Iterable<Type> types = const [ResponseWebsiteDTO, _$ResponseWebsiteDTO];

  @override
  final String wireName = r'ResponseWebsiteDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ResponseWebsiteDTO object, {
  ...
  void _deserializeProperties(
    ...
    required ResponseWebsiteDTOBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'accessLog':
          ...
          break;
        case r'accessLogPath':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          ) as String;
          result.accessLogPath = valueDes;
          break;
        case r'alias':
          final valueDes = serializers.deserialize(
            value,
  ...
  @override
  ResponseWebsiteDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ResponseWebsiteDTOBuilder();
