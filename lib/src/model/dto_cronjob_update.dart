...
part 'dto_cronjob_update.g.dart';
...
/// * [website] 
@BuiltValue()
abstract class DtoCronjobUpdate implements Built<DtoCronjobUpdate, DtoCronjobUpdateBuilder> {
  ...
  factory DtoCronjobUpdate([void updates(DtoCronjobUpdateBuilder b)]) = _$DtoCronjobUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DtoCronjobUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DtoCronjobUpdate> get serializer => _$DtoCronjobUpdateSerializer();
}

class _$DtoCronjobUpdateSerializer implements PrimitiveSerializer<DtoCronjobUpdate> {
  @override
  final Iterable<Type> types = const [DtoCronjobUpdate, _$DtoCronjobUpdate];

  @override
  final String wireName = r'DtoCronjobUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DtoCronjobUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required DtoCronjobUpdateBuilder result,
  ...
  @override
  DtoCronjobUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DtoCronjobUpdateBuilder();
