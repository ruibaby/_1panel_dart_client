...
part 'response_website_ssldto.g.dart';
...
/// * [websites] 
@BuiltValue()
abstract class ResponseWebsiteSSLDTO implements Built<ResponseWebsiteSSLDTO, ResponseWebsiteSSLDTOBuilder> {
  ...
  ResponseWebsiteSSLDTO._();

  factory ResponseWebsiteSSLDTO([void updates(ResponseWebsiteSSLDTOBuilder b)]) = _$ResponseWebsiteSSLDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ResponseWebsiteSSLDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ResponseWebsiteSSLDTO> get serializer => _$ResponseWebsiteSSLDTOSerializer();
}

class _$ResponseWebsiteSSLDTOSerializer implements PrimitiveSerializer<ResponseWebsiteSSLDTO> {
  @override
  final Iterable<Type> types = const [ResponseWebsiteSSLDTO, _$ResponseWebsiteSSLDTO];

  @override
  final String wireName = r'ResponseWebsiteSSLDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ResponseWebsiteSSLDTO object, {
  ...
  void _deserializeProperties(
    ...
    required ResponseWebsiteSSLDTOBuilder result,
  ...
  @override
  ResponseWebsiteSSLDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ResponseWebsiteSSLDTOBuilder();
