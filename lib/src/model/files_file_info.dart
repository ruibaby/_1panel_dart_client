...
/// * [user] 
@BuiltValue()
abstract class FilesFileInfo implements Built<FilesFileInfo, FilesFileInfoBuilder> {
  ...
  factory FilesFileInfo([void updates(FilesFileInfoBuilder b)]) = _$FilesFileInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FilesFileInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FilesFileInfo> get serializer => _$FilesFileInfoSerializer();
}

class _$FilesFileInfoSerializer implements PrimitiveSerializer<FilesFileInfo> {
  @override
  final Iterable<Type> types = const [FilesFileInfo, _$FilesFileInfo];

  @override
  final String wireName = r'FilesFileInfo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    FilesFileInfo object, {
  ...
  void _deserializeProperties(
    ...
    required FilesFileInfoBuilder result,
  ...
  @override
  FilesFileInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FilesFileInfoBuilder();
