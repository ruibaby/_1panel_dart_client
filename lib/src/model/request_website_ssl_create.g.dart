...
part of 'request_website_ssl_create.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RequestWebsiteSSLCreate extends RequestWebsiteSSLCreate {
  @override
  ...
  factory _$RequestWebsiteSSLCreate(
          [void Function(RequestWebsiteSSLCreateBuilder)? updates]) =>
      (new RequestWebsiteSSLCreateBuilder()..update(updates))._build();

  _$RequestWebsiteSSLCreate._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        acmeAccountId, r'RequestWebsiteSSLCreate', 'acmeAccountId');
    BuiltValueNullFieldError.checkNotNull(
        primaryDomain, r'RequestWebsiteSSLCreate', 'primaryDomain');
    BuiltValueNullFieldError.checkNotNull(
        provider, r'RequestWebsiteSSLCreate', 'provider');
  }

  @override
  RequestWebsiteSSLCreate rebuild(
          void Function(RequestWebsiteSSLCreateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RequestWebsiteSSLCreateBuilder toBuilder() =>
      new RequestWebsiteSSLCreateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RequestWebsiteSSLCreate &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RequestWebsiteSSLCreate')
...
class RequestWebsiteSSLCreateBuilder
    implements
        Builder<RequestWebsiteSSLCreate, RequestWebsiteSSLCreateBuilder> {
  _$RequestWebsiteSSLCreate? _$v;
  ...
  RequestWebsiteSSLCreateBuilder() {
    RequestWebsiteSSLCreate._defaults(this);
  }

  RequestWebsiteSSLCreateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(RequestWebsiteSSLCreate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RequestWebsiteSSLCreate;
  }

  @override
  void update(void Function(RequestWebsiteSSLCreateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RequestWebsiteSSLCreate build() => _build();

  _$RequestWebsiteSSLCreate _build() {
    final _$result = _$v ??
        new _$RequestWebsiteSSLCreate._(
