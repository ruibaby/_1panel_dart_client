...
class PHPExtensionsApi {
  ...
  const PHPExtensionsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> runtimesPhpExtensionsDelPost({ 
    required RequestPHPExtensionsDelete request,
    ...
    final _path = r'/runtimes/php/extensions/del';
    ...
    try {
      const _type = FullType(RequestPHPExtensionsDelete);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> runtimesPhpExtensionsPost({ 
    required RequestPHPExtensionsCreate request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/runtimes/php/extensions';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestPHPExtensionsCreate);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
  ...
  Future<Response<BuiltList<ResponsePHPExtensionsDTO>>> runtimesPhpExtensionsSearchPost({ 
    ...
    final _path = r'/runtimes/php/extensions/search';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestPHPExtensionsSearch);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> runtimesPhpExtensionsUpdatePost({ 
    required RequestPHPExtensionsUpdate request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/runtimes/php/extensions/update';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestPHPExtensionsUpdate);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
